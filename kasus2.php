                    ...
                    <div class="contentpanel">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <h4 class="panel-title">Kasus 2 - Query Untuk Menampilkan Data Pasien yang Masih Aktif </h4>
                                <br>
                                

                                     
                                <form action="" method="post">
                                Menampilkan Data Pasien Yang Masih Aktif 
                    ...
                          
                        ...
                                </script> 
                                    ...
                                    <?php                                      
                                         ...
                                         $tampil= mysql_query("SELECT  m.tanggal,n.nama_pasien,n.jenis_kelamin,o.nama_diagnosa,q.nama_status FROM dim_waktu m, dim_pasien n, dm_diagnosa o,fact_pasien_rawat p,dim_status q WHERE p.ID_waktu=m.ID_waktu AND p.IDpasien=n.IDpasien AND p.IDdiagnosa=o.IDdiagnosa AND nama_status='Aktif' ORDER BY m.tanggal ASC;");
                                    ?>

                                    

                            <h4 align="center">Tabel Pasien Aktif</h4>

                            <div class="panel-body"><table align="center" class="table1" border=”1″>
                                    <tr>
                                    <th>No</th>
                                    <th>Tanggal</th>
                                    <th>Nama Pasien</th>
